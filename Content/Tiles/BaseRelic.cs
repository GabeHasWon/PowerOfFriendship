...
public abstract class BaseRelic<T> : ModTile where T : ModItem
{
    ...
    public const string PathToRelics = "PoF/Content/Tiles/";
...
public class EoDRelic : BaseRelic<EoDRelicItem> { }

public class EoDRelicItem : ModItem
{
    public override void SetDefaults()
    {
        Item.DefaultToPlaceableTile(ModContent.TileType<EoDRelic>());
        Item.master = true;
