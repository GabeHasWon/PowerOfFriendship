...
public class EoDBag : BossBagItem
{
    ...
    {
        itemLoot.AddOneFromOptions<KissOfDeath, VoidRippers, BandOfCommitment, BlackDeath>();
        itemLoot.AddCommon<DarkOrb>(1);
        AddBossItems<EoDTrophyItem>(itemLoot, 25..30);
    }
}